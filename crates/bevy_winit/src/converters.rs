...
pub fn convert_keyboard_input(keyboard_input: &winit::event::KeyEvent) -> KeyboardInput {
    KeyboardInput {
        ...
        key_code: convert_key_code(keyboard_input.physical_key),
    }
}
...
pub fn convert_key_code(key_code: winit::keyboard::KeyCode) -> KeyCode {
    match key_code {
        winit::keyboard::KeyCode::Unidentified(native_key_code) => {
            KeyCode::Unidentified(convert_native_key_code(native_key_code))
        }
        ...
        unknown => {
            warn!("Skipped conversion for unknown KeyCode {:?}", unknown);
            KeyCode::Unidentified(NativeKeyCode::Unidentified)
        }
    }
}

fn convert_native_key_code(native_key_code: winit::keyboard::NativeKeyCode) -> NativeKeyCode {
    match native_key_code {
        winit::keyboard::NativeKeyCode::Unidentified => NativeKeyCode::Unidentified,
        winit::keyboard::NativeKeyCode::Windows(kc) => NativeKeyCode::Windows(kc),
        winit::keyboard::NativeKeyCode::MacOS(kc) => NativeKeyCode::MacOS(kc),
        winit::keyboard::NativeKeyCode::XkbCode(kc) => NativeKeyCode::XkbCode(kc),
        winit::keyboard::NativeKeyCode::XkbSym(kc) => NativeKeyCode::XkbSym(kc),
    }
}
